...
namespace roadmanager
{
    ...
    */
    ...
    public:
        ...
        void SetContactPointType(ContactPointType contact_point_type)
        {
            contact_point_type_ = contact_point_type;
        }
    ...
    public:
        ...
        */
        ...
        const std::vector<PathNode *> &GetVisitedNodes() const
        {
            return visited_;
        }
        const std::vector<PathNode *> &GetOnlyVisitedPath() const
        {
            return only_visited_path_;
        }
