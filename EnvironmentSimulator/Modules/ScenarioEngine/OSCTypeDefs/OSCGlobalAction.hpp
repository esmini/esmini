...
namespace scenarioengine
{
    ...
    public:
        ...
        std::vector<RoadRangePathNode> CalculatePathBetweenCursors(const RoadCursor& start_cursor, const RoadCursor& end_cursor, double& dist);
        std::vector<RoadRangePathNode> CalculateRoadRangePath(const RoadRange& road_range, double& total_dist);
