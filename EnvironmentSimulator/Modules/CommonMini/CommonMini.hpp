...
/**
        Portable and safe function to get environment variables
        Return value should be copied, since the buffer will be re-used between calls
*/
...
/**
        ...
        Note: The resulting complete search paths must be absolute
