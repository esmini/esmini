...
#include "ControllerExternalDriverModel.hpp"
...
Controller* scenarioengine::InstantiateControllerExternalDriverModel(void* args)
{
	Controller::InitArgs* initArgs = (Controller::InitArgs*)args;

	return new ControllerExternalDriverModel(initArgs);
}

void ControllerExternalDriverModel::Init()
{

	Controller::Init();
}

void ControllerExternalDriverModel::Step(double timeStep)
{
...
void ControllerExternalDriverModel::Activate(ControlDomains domainMask)
{
	if (object_)
	{
		vehicle_.Reset();
...
void ControllerExternalDriverModel::ReportKeyEvent(int key, bool down)
{
}
