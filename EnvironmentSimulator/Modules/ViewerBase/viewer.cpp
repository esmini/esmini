...
void CarModel::AddLights(osg::ref_ptr<osg::Group> group, bool showLights)
{
    for (int j = 0; j < Object::VehicleLightType::NUMBER_OF_VEHICLE_LIGHTS; j++)
    {
        ...
        else
        {
            ...
            if (showLights)
            {
                LOG_ONCE("Missing light materials node itself in vehicle model %s - ignoring visualization", group->getName().c_str());
            }
        }
    }
}
    ...
    for (unsigned i = 0; i < Object::VehicleLightType::NUMBER_OF_VEHICLE_LIGHTS; i++)
    {
        if (list[i].type != Object::VehicleLightType::UNDEFINED)
        {
            ...
            if (list[i].type == Object::VehicleLightType::WARNING_LIGHTS)
            {
                ...
                {
                    LOG_ONCE("Missing light node - %s - ignoring visualization", LightTypeInd2Str(Object::VehicleLightType::INDICATOR_LEFT).c_str());
                }
                ...
                {
                    LOG_ONCE("Missing light node - %s - ignoring visualization", LightTypeInd2Str(Object::VehicleLightType::INDICATOR_RIGHT).c_str());
                }
            }
            else if (list[i].type == Object::VehicleLightType::FOG_LIGHTS)
            {
                ...
                {
                    LOG_ONCE("Missing light node - %s - ignoring visualization",
                             LightTypeInd2Str(Object::VehicleLightType::FOG_LIGHTS_FRONT).c_str());
                }
                ...
                {
                    LOG_ONCE("Missing light node - %s - ignoring visualization", LightTypeInd2Str(Object::VehicleLightType::FOG_LIGHTS_REAR).c_str());
                }
            }
            else
            {
                ...
                {
                    LOG_ONCE("Missing light node - %s - ignoring visualization", LightTypeInd2Str(static_cast<Object::VehicleLightType>(i)).c_str());
                }
            }
        }
    }
