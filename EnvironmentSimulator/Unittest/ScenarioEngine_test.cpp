...
{
    Position::GetOpenDrive()->LoadOpenDriveFile((std::string(getRunfilesDir().c_str()) + "resources/xodr/straight_500m.xodr").c_str());
...
TEST(DistanceTest, DistanceWithTrailers)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/distance_with_trailers.xosc").c_str());
...
TEST(DistanceTest, TestTrajectoryDistance)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "resources/xosc/lane-change_clothoid_based_trajectory.xosc").c_str());
...
TEST(TrajectoryTest, EnsureContinuation)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/trajectory-continuity.xosc").c_str());
    ASSERT_NE(se, nullptr);
...
TEST(TrajectoryTest, PolyLineContinuosSpeed)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/brake_by_trajectory_100-0.xosc").c_str());
...
TEST(TrajectoryTest, FollowTrajectoryReverse)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/follow_trajectory_reverse.xosc").c_str());
...
TEST(JunctionTest, JunctionSelectorTest)
{
    ...
    {
        ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/junction-selector.xosc").c_str());
        se->step(0.0);
        se->prepareGroundTruth(0.0);
        ASSERT_NE(se, nullptr);
...
TEST(ConditionTest, CollisionTest)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/test-collision-detection.xosc").c_str(), true);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
    ASSERT_NE(se, nullptr);
...
TEST(ControllerTest, UDPDriverModelTestAsynchronous)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "scripts/udp_driver/two_cars_in_open_space.xosc").c_str());
    ASSERT_NE(se, nullptr);
...
TEST(RoadOrientationTest, TestElevationPitchRoll)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/elevations.xosc").c_str());
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/four_roads.xosc").c_str());
...
TEST(ControllerTest, ALKS_R157_TestR157RegulationMinDist)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/alks_r157_test.xosc").c_str());
    ASSERT_NE(se, nullptr);
    ASSERT_EQ(se->entities_.object_.size(), 2);
...
TEST(ControllerTest, ALKS_R157_TestR157RefDriverBrakeRate)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/alks_r157_quick_stop_test.xosc").c_str());
        ASSERT_NE(se, nullptr);
...
protected:
    static void SetUpTestSuite()
    {
        ...
        ASSERT_EQ(roadmanager::Position::LoadOpenDrive((std::string(getRunfilesDir().c_str()) + "resources/xodr/straight_500m.xodr").c_str()), true);
...
TEST(DistributionTest, TestDeterministicDistribution)
{
    ...
    EXPECT_EQ(dist.Load((std::string(getRunfilesDir().c_str()) + "resources/xosc/cut-in_parameter_set.xosc").c_str()), 0);
...
TEST(SpeedTest, TestAbsoluteSpeed)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/lateral_maneuvers_test.xosc").c_str());
    ASSERT_NE(se, nullptr);
...
TEST(ControllerTest, TestLoomingControllerSimple)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/loomingTest.xosc").c_str());
    ASSERT_NE(se, nullptr);
...
TEST(RelativeClearanceTest, TestRelativeClearanceFreeSpace)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_clearance_freeSpace.xosc").c_str());
        ASSERT_NE(se, nullptr);
...
TEST(TwoPlusOneRoadTest, TestTwoPlusOneRoad)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "resources/xosc/two_plus_one_road.xosc").c_str());
    struct
    {
        double time;
        double s;
...
TEST(RelativeClearanceTest, TestRelativeClearanceOppositeLane)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_clearance_oppositLane.xosc").c_str());
        ASSERT_NE(se, nullptr);
...
TEST(ControllerTest, TestLoomingControllerAdvanced)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/loomingAdvancedTest.xosc").c_str());
    ASSERT_NE(se, nullptr);
...
TEST(ConditionTest, TestTTCAndLateralDist)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/ttc_condition.xosc").c_str());
        ASSERT_NE(se, nullptr);
...
TEST(ActionTest, TestRelativeLaneChangeAction)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_lane_change.xosc").c_str());
    ASSERT_NE(se, nullptr);
    ASSERT_EQ(se->entities_.object_[0]->GetName(), "Ego");
...
TEST(ActionTest, TestRelativeLaneOffsetAction)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_lane_offset.xosc").c_str());
    ASSERT_NE(se, nullptr);
    ASSERT_EQ(se->entities_.object_[0]->GetName(), "Ego");
    ASSERT_EQ(se->entities_.object_[1]->GetName(), "Target1");
    ASSERT_EQ(se->entities_.object_[2]->GetName(), "Target2");
...
TEST(ActionTest, TestRelativeLanePosition)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_lane_pos_trajectories.xosc").c_str());
    ASSERT_NE(se, nullptr);
    ASSERT_EQ(se->entities_.object_[0]->GetName(), "Ego");
    ASSERT_EQ(se->entities_.object_[1]->GetName(), "Target");
...
TEST(ActionTest, TestRelativeLaneOffsetPosition)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_lane_pos_offset_trajectories.xosc").c_str());
    ASSERT_NE(se, nullptr);
    ASSERT_EQ(se->entities_.object_[0]->GetName(), "Ego");
    ASSERT_EQ(se->entities_.object_[1]->GetName(), "Target");
...
TEST(PositionTest, TestPositionMode)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/positioning_slope_up_leaning_right.xosc").c_str());
    ASSERT_NE(se, nullptr);
...
TEST(PositionTest, TestPositionTypes)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/position_types.xosc").c_str());
    ASSERT_NE(se, nullptr);
...
TEST(ClothoidSplineTest, TestTrajectoryShape)
{
    ...
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "resources/xosc/lane-change_clothoid_spline_based_trajectory.xosc").c_str());
    ASSERT_NE(se, nullptr);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_pos_over_intersection.xosc").c_str());
    ASSERT_NE(se, nullptr);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
    scenarioengine::Entities* entities = &se->entities_;
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/friction_and_lane_change_edge_case.xosc").c_str());
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "resources/xosc/lane_change_crest.xosc").c_str());
    ASSERT_NE(se, nullptr);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/bike_tilt_smooth.xosc").c_str());
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/relative_speed_phases.xosc").c_str());
    const double    dt = 0.05;
    ASSERT_NE(se, nullptr);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/instant_lane_change.xosc").c_str());
    const double    dt = 0.05;
    ASSERT_NE(se, nullptr);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/route_detour.xosc").c_str(), true);
    const double    dt = 0.05;
    ASSERT_NE(se, nullptr);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
...
{
    ScenarioEngine* se = new ScenarioEngine((std::string(getRunfilesDir().c_str()) + "EnvironmentSimulator/Unittest/xosc/test_elevation_mapping.xosc").c_str(), false);
    const double    dt = 0.1;
    ASSERT_NE(se, nullptr);
    se->step(0.0);
    se->prepareGroundTruth(0.0);
