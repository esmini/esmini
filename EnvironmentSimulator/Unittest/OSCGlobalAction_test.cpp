...
static std::string ToString(const LaneSegment& ls)
{
    std::ostringstream os;
    os << "{roadId=" << ls.roadId << ", laneId=" << ls.laneId << ", minS=" << ls.minS << ", maxS=" << ls.maxS << ", length=" << ls.length << "}";
    return os.str();
}
...
TEST_P(TrafficAreaActionRoadPathInvestigationTest, RoadPathInvestigationTest)
{
    ...
    std::vector<LaneSegment> missing_generated;
    for (const auto& ls : generated_lane_segments)
    {
        bool found = std::any_of(expected_lane_segments.begin(), expected_lane_segments.end(), [&](const LaneSegment& e) { return ls == e; });
        if (!found)
            missing_generated.push_back(ls);
    }

    std::ostringstream msg;
    for (const auto& ls : missing_generated)
        msg << ToString(ls) << "\n";
    EXPECT_TRUE(missing_generated.empty()) << "Generated but not expected:\n" << msg.str();
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        RoadPathTestParam{
            ...
            RoadRange{0,
                      {RoadCursor{0, 50, {-1, -2}},
                       ...
                       RoadCursor{4, 75, {1, -1}},
                       RoadCursor{5, 50, {-1, -2}}}},
            {LaneSegment{0, -1, 50, 100, 50}, LaneSegment{0, -2, 50, 100, 50}, LaneSegment{1, -1, 0, 100, 100}, LaneSegment{1, -2, 0, 100, 100},
             LaneSegment{2, -1, 0, 50, 50},   LaneSegment{2, -2, 0, 50, 50},   LaneSegment{2, 2, 50, 100, 50},  LaneSegment{2, 1, 50, 100, 50},
             LaneSegment{2, -1, 50, 100, 50}, LaneSegment{2, -2, 50, 100, 50}, LaneSegment{4, 2, 0, 25, 25},    LaneSegment{4, 1, 0, 25, 25},
             LaneSegment{4, -1, 0, 25, 25},   LaneSegment{4, -2, 0, 25, 25},   LaneSegment{4, 1, 25, 75, 50},   LaneSegment{4, -1, 25, 75, 50},
             LaneSegment{4, -2, 25, 75, 50},  LaneSegment{4, 1, 75, 100, 25},  LaneSegment{4, -1, 75, 100, 25}, LaneSegment{5, 1, 0, 50, 50},
             LaneSegment{5, -1, 0, 50, 50}}},
        RoadPathTestParam{"../../../EnvironmentSimulator/Unittest/xodr/road_range_test/big_offset_junction_creators.xodr",
                          RoadRange{0, {RoadCursor{0, 50, {-1, -2, -3, -4}}, RoadCursor{5, 50, {-1, -2}}}},
                          {LaneSegment{0, -1, 50, 100, 50},
                           LaneSegment{0, -2, 50, 100, 50},
        ...
        RoadPathTestParam{
            ...
            RoadRange{
                0,
                {RoadCursor{0, 50, {-1, -2, -3, -4}}, RoadCursor{5, 50, {-2}}, RoadCursor{9, 0, {-1, -2, -3, -4}}, RoadCursor{9, 50, {-1, -2}}}},
            {LaneSegment{0, -1, 50, 100, 50},
             LaneSegment{0, -2, 50, 100, 50},
             LaneSegment{0, -3, 50, 100, 50},
             LaneSegment{0, -4, 50, 100, 50},
        ...
        RoadPathTestParam{"../../../EnvironmentSimulator/Unittest/xodr/road_range_test/opposite_pointing_roads_LLL.xodr",
                          RoadRange{0, {RoadCursor{0, 25, {-1, -2}}, RoadCursor{1, 50, {1, -1, -2}}, RoadCursor{2, 75, {1, 2, -1, -2}}}},
                          {LaneSegment{0, -1, 0, 25, 25},
                           LaneSegment{0, -2, 0, 25, 25},
                           LaneSegment{1, -1, 50, 100, 50},
                           LaneSegment{1, -2, 50, 100, 50},
                           LaneSegment{1, 1, 0, 50, 50},
                           LaneSegment{1, -1, 0, 50, 50},
                           LaneSegment{1, -2, 0, 50, 50},
                           LaneSegment{2, 1, 75, 100, 25},
                           LaneSegment{2, -1, 75, 100, 25},
                           LaneSegment{2, -2, 75, 100, 25}}},
        RoadPathTestParam{"../../../EnvironmentSimulator/Unittest/xodr/road_range_test/opposite_pointing_roads_LRR.xodr",
                          RoadRange{0, {RoadCursor{0, 25, {-1, -2}}, RoadCursor{1, 50, {1, -1, -2}}, RoadCursor{2, 75, {1, 2, -1, -2}}}},
                          {LaneSegment{0, -1, 0, 25, 25},
                           LaneSegment{0, -2, 0, 25, 25},
                           ...
                           LaneSegment{2, 1, 0, 75, 75},
                           LaneSegment{2, -1, 0, 75, 75},
                           LaneSegment{2, -2, 0, 75, 75}}},
        RoadPathTestParam{"../../../EnvironmentSimulator/Unittest/xodr/road_range_test/opposite_pointing_roads_RLR.xodr",
                          RoadRange{0, {RoadCursor{0, 25, {-1, -2}}, RoadCursor{1, 50, {1, -1, -2}}, RoadCursor{2, 75, {1, 2, -1, -2}}}},
                          {LaneSegment{0, -1, 25, 100, 75},
                           LaneSegment{0, -2, 25, 100, 75},
                           ...
                           LaneSegment{2, 1, 0, 75, 75},
                           LaneSegment{2, 2, 0, 75, 75}}},
        RoadPathTestParam{"../../../EnvironmentSimulator/Unittest/xodr/road_range_test/opposite_pointing_roads_RRL.xodr",
                          RoadRange{0, {RoadCursor{0, 25, {-1, -2}}, RoadCursor{1, 50, {1, -1, -2}}, RoadCursor{2, 75, {1, 2, -1, -2}}}},
                          {LaneSegment{0, -1, 25, 100, 75},
                           LaneSegment{0, -2, 25, 100, 75},
                           ...
                           LaneSegment{2, 1, 75, 100, 25},
                           LaneSegment{2, 2, 75, 100, 25}}},
        RoadPathTestParam{"../../../EnvironmentSimulator/Unittest/xodr/road_range_test/opposite_pointing_roads_RRR.xodr",
                          RoadRange{0, {RoadCursor{0, 25, {-1, -2}}, RoadCursor{1, 50, {1, -1, -2}}, RoadCursor{2, 75, {1, 2, -1, -2}}}},
                          {LaneSegment{0, -1, 25, 100, 75},
                           LaneSegment{0, -2, 25, 100, 75},
                           LaneSegment{1, -1, 0, 50, 50},
