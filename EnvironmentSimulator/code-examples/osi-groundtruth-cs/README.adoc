...
It's dependent on the https://github.com/esmini/esmini/blob/master/EnvironmentSimulator/Libraries/esminiLib/ESMiniWrapper.cs[ESMiniWrapper.cs].
...
----
cd ../../../../bin
../EnvironmentSimulator/code-examples/osi-groundtruth-cs/linux/bin/Release/net8.0/osi-groundtruth
----

== How to create the osi3 C# files
For this example the osi3 C# files were provided. If you need or want to compile them yourself (Windows example):
