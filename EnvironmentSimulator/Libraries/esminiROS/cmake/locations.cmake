...
macro(set_project_internal_paths)
    ...
    set(CODE_EXAMPLES_BIN_PATH
        ${ESMINI_PATH}/code-examples-bin)
    set(ENVIRONMENT_SIMULATOR_PATH
        ${ESMINI_PATH}/EnvironmentSimulator)
    set(RESOURCES_PATH
        ${ESMINI_PATH}/resources)
    set(RUN_PATH
        ${ESMINI_PATH}/run)
    set(SUPPORT_PATH
        ${ESMINI_PATH}/support)
...
macro(set_project_external_paths)
    ...
    set(EXTERNALS_YAMLCPP_PATH
        ${EXTERNALS_PATH}/yaml-cpp)
    set(MODELS_PATH
...
macro(set_project_includes)
    ...
    set(EXTERNALS_YAMLCPP_INCLUDES
        ${EXTERNALS_YAMLCPP_PATH}/include)
