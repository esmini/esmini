...
- Objects can additionally carry *markings* (e.g. painted lines for crosswalks and parking spaces); see the OpenDRIVE marking definitions. Markings are kept at the object's floor level and follow the (possibly scaled) outline edges while preserving their authored line width.
