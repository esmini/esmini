...
==== Custom color (esmini extension)

The default color of a https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.9.0/specification/13_objects/13_01_introduction.html[road object] is determined by the https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.9.0/specification/16_annexes/enumerations/map_uml_enumerations.html#top-EAID_C47587D0_7173_42df_8BB7_36B2C598D95F[objectType]. To override this, use the `color` `userData` attribute on the `<object>` element. The value should be a hex RGB color code (e.g., `#FF0000` for red).
...
<object id="1" s="20" t="5" zOffset="0.0" length="5" width="1" height="1">
   <userData code="color" value="#3090B0"/>  <!-- custom blueish color -->
</object>
----
...
*Note*: A texture overrides any color, even when specified in `userData`.
