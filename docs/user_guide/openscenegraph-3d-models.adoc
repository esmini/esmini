...
http://www.openscenegraph.org/[OpenSceneGraph] (osg) includes readers and writers for quite a few 3D file formats. It comes with a demo application, https://openscenegraph.github.io/OpenSceneGraphDotComBackup/OpenSceneGraph/www.openscenegraph.com/index.php/documentation/user-guides/55-osgconv.html[osgconv], a command line tool that simply takes one file as input and outputs the same content in a different format.
...
Find more info on COLLADA via this old https://openscenegraph.github.io/OpenSceneGraphDotComBackup/OpenSceneGraph/www.openscenegraph.com/index.php/documentation/guides/user-guides/111-collada.html[link].
