...
- https://github.com/esmini/esmini-dependencies/blob/main/osi/generate_osi_3_8_libs.sh[esmini-dependencies/osi/generate_osi_3_8_libs.sh]
...
|===
| CMake flag | OSI version | Google Protobuf version | Abseil version
| `-D OSI_VERSION=3.5.0` (default) | v3.5.0 | v3.15.2 | N/A
| `-D OSI_VERSION=3.8.0` | v3.8.0 | v5.29.3 | 20240722.1
|===

Example:

`cmake .. -D OSI_VERSION=3.5.0`
...
[cols="1,1,1,1", options="header"]
|===
| CMake flag | Implot version | ImGui version | GLFW version
| `-D IMPLOT_VERSION=0.16` | v0.16 | v1.89.8 | 3.3.8
|===
...
The external dependencies OSG, OSI, SUMO, implot and PROJ are optional. Also the unit test suite is optional, in effect making the dependecy to googletest framework optional as well. All these options are simply controlled by the following cmake options:
...
To disable all run:  +
``cmake .. -D USE_OSG=False -D USE_SUMO=False -D USE_OSI=False -D USE_GTEST=False -D USE_IMPLOT=False -D USE_PROJ=False``
