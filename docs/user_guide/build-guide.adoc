...
Linux: +
``export LD_LIBRARY_PATH=./externals/osi/v3.8.0_1/linux/lib-dyn``

macOS: +
``export DYLD_LIBRARY_PATH=./externals/osi/v3.8.0_1/linux/lib-dyn``

*Note:* +
The dynamic versions of protobuf and OSI are built on need basis, `v3.8.0_1` corresponds to a specific osi version + build number, the tags available can be found at <github_build_link>.
