...
- https://github.com/esmini/esmini-dependencies/blob/main/osi/generate_osi_3_5_libs.sh[scripts/generate_osi_libs.sh]

or this script that builds all `sumo` and `osg` libs, combining the above ones:
...
For `osi` and `implot`, the supported versions can be found in https://github.com/esmini/esmini/blob/master/support/cmake/common/version_mapping.cmake.
