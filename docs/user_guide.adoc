...
esmini is primarily utilizing cmake for build configuration. The repository includes a git submodule for OSI support, so make sure to clone recursively:
...
If you do not need OSI support you can skip the two-phase build entirely:
