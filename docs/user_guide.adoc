...
.\main.py run format --cmake_format
.\main.py run format --black_format
----
...
[source, txt]
----
.\main.py run format --clang_format_checker
.\main.py run format --cmake_format_checker
.\main.py run format --black_format_checker
----
