...
For explanation of the `RoadGeom`  constructor parameters, see the API documentation or the source code in https://github.com/esmini/esmini/blob/295aa1a09aa9786b4906300496b55f6f4f820148/EnvironmentSimulator/Modules/ViewerBase/roadgeom.hpp#L66-L82[`RoadGeom.hpp`].
...
Full code example here: https://github.com/esmini/esmini/blob/feature/refactor_road_obj_tesselation_rb/EnvironmentSimulator/code-examples/road-model[code-examples/road-model]

==== Node naming

For post processing the esmini generated nodes are named as following example:
...
The second number in road nodes indicate just subsegment of the road, i.e. one road will typically have a number of separate segments.
