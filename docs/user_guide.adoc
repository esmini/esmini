...
==== cppcheck version
As of esmini v2.47.0, the esmini CI/CD pipeline runs Cppcheck v2.17 on Ubuntu 24.04.

If a different version of Cppcheck is required, e.g. due to specific dependencies, it is recommended to make use of esmini CI/CD system for static code analysis. In such case, the recommended approach is to create a fork of the esmini repository and conducting the analysis within that environment, simply by pushing the code.
