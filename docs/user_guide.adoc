...
A 2+1 example example scenario is found here: https://github.com/esmini/esmini/blob/4e45f132f13963a89e4b473c1bb16d9940d5c7cf/resources/xosc/two_plus_one_road.xosc[resources/xosc/two_plus_one_road.xosc]
