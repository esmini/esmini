...
From v2.46.3, esmini utilizes https://pre-commit.com/[pre-commit hooks] for these checks. For details of previous implementation, see older versions of this document, e.g. https://htmlpreview.github.io/?https://raw.githubusercontent.com/esmini/esmini.github.io/refs/tags/v2.46.2/index.html[v2.46.2].
...
To run pre-commit using this local build of Cppcheck 2.17, run the following from your esmini root folder:
[source, txt]
----
PATH="$HOME/cppcheck-2.17.1/build/bin:$PATH" pre-commit run cppcheck --all-files
----

This command temporarily uses your locally built Cppcheck 2.17 without changing your system default.
