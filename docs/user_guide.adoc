...
Currently OpenSCENARIO XML does not support defining 2D shape outlines in a standardized way. However, the Property elements of https://publications.pages.asam.net/standards/ASAM_OpenSCENARIO/ASAM_OpenSCENARIO_XML/latest/generated/content/EntityObject.html[EntityObject] (Vehicle, Pedestrian, MiscObject) can be utilized for this purpose. From version 2.57.3 esmini supports reading 2D shape outlines defined as property with name `outline` and value on the format: `x0,y0;x1,y1;x2,y2,...`. Example of four points:
...
A full example, shown in image above, can be found in the esmini demo vehicle catalog https://github.com/esmini/esmini/blob/3c008aaac1b363beaab51041284164199156d027/resources/xosc/Catalogs/Vehicles/VehicleCatalog.xosc#L53-L87[VehicleCatalog.xosc/car_white_with_outline]. Points calculated using this https://docs.google.com/spreadsheets/d/1Bc6T6FH1yP6PzW9zeZdmwzWGdaDU6vs17frhorkltHI/edit?usp=sharing[Google sheet] (`File -> Make a copy` to edit your own values).

The test scenario https://github.com/esmini/esmini/blob/dev/EnvironmentSimulator/Unittest/xosc/shape_outlines.xosc[shape_outlines.xosc] includes a few more examples for various entity types.
