...
See code examples in ScenarioEngineDLL test cases, e.g: https://github.com/esmini/esmini/blob/d3bd16ea0aaf11b04929bc8c9d9191922000c383/EnvironmentSimulator/Unittest/ScenarioEngineDll_test.cpp#L953-L997[receive_GroundTruth].
