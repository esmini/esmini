...
Here are links to a few Vehicles, including asset structure and scripts, created in Blender:

- https://drive.google.com/file/d/1ZNukIo5FeR0I0LgBVM5BRI1y_HnP2rTV/view?usp=drive_link[esmini_vehicles.7z]
- https://drive.google.com/file/d/1TCqp2FxNv2FscCsaCNmbIomS24dHM97e/view?usp=drive_link[esmini_assets.7z]
