...
|*Properties*:
a| [horizontal]
`logLevel`:: 0: No logging, 1: Brief logging of state changes, 2: Verbose logging of some internal variables
`model`:: Regulation, ReferenceDriver, FSM, RSS as described above.
`cruise`:: Activate longitudinal ACC (comfort adaptive speed control) (`true`/`false`)
|*Examples*:|
https://github.com/esmini/esmini/blob/master/EnvironmentSimulator/Unittest/xosc/alks_r157_cut_in_quick_brake.xosc[alks_r157_cut_in_quick_brake.xosc] +
