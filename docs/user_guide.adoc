...
----
Figure 2
From the figure 2, Object reference point is (30,0) and the repeat reference point is (25, 5). So the reference point is shifted by (25- 30 = -5, 5 – 0 = 5) . The outline shall also be shifted by (-5,5).
...
----
Figure 3
From the figure 3, Object reference point is (30,0) and the repeat reference point is (25, 5). So the reference point is shifted by (25- 30 = -5, 5 – 0 = 5) . The two outlines shall also be shifted by (-5,5). The compound bounding box info shall be used for repeat calculations like compound length.
...
Basically markings shall be added to any type of stationary object either by mentioning side of the stationary object or by referring to the id of the outline corners. For detailed view of how marking is pharsed look the flowchart https://www.draw.io?lightbox=1&edit=_blank#Uhttps%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D1AB-qfGjadGYRa4UL18DwLVXu0JVDJ_xH%26export%3Ddownload[marking pharser]


==== Example
The openDRIVE file Ex_Markings_Demo.xodr includes set of markings like german crosswalk, swedish crosswalk, parrel parking, perpendicular parking. Below are the example figures.
