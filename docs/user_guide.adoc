...
esmini supports all three (as of OpenSCENARIO 1.2) file:///C:/eknabe1/GIT/openscenario/additional_content/Model/modelDocumentation/content/Shape.html[shapes]:
