...
Below 3 ways shall be used to run all permutations with esmini:
...
The first two ways will run all permutations of the scenario defined in the parameter set file. The third way will run the scenario defined in the scenario file, but with all permutations of the parameter set file.
...
- `SE_UpdateOSIGroundTruth(true)`: OSI groundtruth will contain static data.
