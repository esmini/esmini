...
https://github.com/OpenSimulationInterface/open-simulation-interface/blob/master/osi3trace/osi2read.py +
...
*Note:* See <<OSI for Python on Windows>> for hints how to install dependencies (OSI and Protobuf)
