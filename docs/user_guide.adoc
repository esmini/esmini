...
The texture will illustrate the lamp face in lit state. When lamp is off it will be just black. Example from https://github.com/esmini/esmini/blob/dev/resources/xosc/traffic_lights.xosc[traffic_lights.xosc]:
