...
class TestSuite(unittest.TestCase):
    ...
    def test_alks(self):
        ...
        self.assertTrue(re.search('^5.060, 200, Ego, 147.737, -1.535, 0.000, 0.000, 0.000, 0.000, 12.531, 0.000, 2.788', csv, re.MULTILINE))
        self.assertTrue(re.search('^5.060, 201, Target, 153.059, -1.535, 0.000, 0.000, 0.000, 0.000, 9.540, 0.035, 1.244', csv, re.MULTILINE))
