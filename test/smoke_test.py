...
class TestSuite(unittest.TestCase):
    ...
    def test_alks(self):
        ...
        self.assertTrue(re.search('^5.020, 200, Ego, 147.719, -1.535, 0.000, 0.000, 0.000, 0.000, 13.426, 0.000, 2.737', csv, re.MULTILINE))
        self.assertTrue(re.search('^5.020, 201, Target, 152.674, -1.535, 0.000, 6.281, 0.000, 0.000, 9.800, 0.049, 0.146', csv, re.MULTILINE))
