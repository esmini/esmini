...
class TestSuite(unittest.TestCase):
    ...
    def test_swarm(self):
        ...
        if platform == "win32":
            ...
            self.assertTrue(re.search('^5.000, 6, swarm_5, -0.226, 489.547, -0.834, 4.662, 6.283, 0.000, 30.000, 0.001, 1.821', csv, re.MULTILINE))
            self.assertTrue(re.search('^5.000, 7, swarm_5\+, 0.092, 495.538, -0.838, 4.660, 6.283, 0.000, 30.000, 0.001, 1.821', csv, re.MULTILINE))
            self.assertTrue(re.search('^5.000, 8, swarm_5\+\+, 0.799, 508.219, -0.844, 4.656, 6.283, 0.000, 30.000, 0.001, 1.821', csv, re.MULTILINE))
            self.assertTrue(re.search('^5.050, 4, swarm_3, 8.870, 180.504, -0.311, 1.563, 0.002, 0.000, 30.000, -0.000, 5.563', csv, re.MULTILINE))
            self.assertTrue(re.search('^20.000, 0, Ego, 16.330, 499.764, -0.841, 1.517, 0.000, 0.000, 10.000, -0.001, 5.942', csv, re.MULTILINE))
            self.assertTrue(re.search('^20.000, 4, swarm_3, 15.249, 478.441, -0.826, 1.523, 0.001, 0.000, 10.280, -0.001, 2.542', csv, re.MULTILINE))
            self.assertTrue(re.search('^20.000, 37, swarm_25, -5.494, 319.062, -0.564, 4.695, 6.281, 0.000, 30.000, 0.000, 4.084', csv, re.MULTILINE))
            ...
            self.assertTrue(re.search('^20.000, 36, swarm_29, -8.228, 367.501, -0.658, 4.689, 6.281, 0.000, 31.177, 0.000, 4.012', csv, re.MULTILINE))
            self.assertTrue(re.search('^20.000, 37, swarm_29\+, -8.081, 373.500, -0.670, 4.688, 6.281, 0.000, 30.000, 0.000, 3.857', csv, re.MULTILINE))
            self.assertTrue(re.search('^20.000, 38, swarm_29\+\+, -7.754, 386.195, -0.693, 4.686, 6.281, 0.000, 30.000, 0.001, 3.857', csv, re.MULTILINE))
            self.assertTrue(re.search('^20.000, 40, swarm_31, 12.411, 403.252, -0.725, 1.542, 0.002, 0.000, 20.147, -0.001, 0.644', csv, re.MULTILINE))
    ...
    def test_route_lane_change(self):
        ...
        # Check vehicle key positions
        csv = generate_csv()
        self.assertTrue(re.search('^1.000, 0, Car, 28.935, -2.205, 0.000, 6.016, 0.000, 0.000, 10.000, 0.356, 3.439', csv, re.MULTILINE))
        self.assertTrue(re.search('^3.130, 0, Car, 49.676, 1.788, 0.000, 0.243, 0.000, 0.000, 10.000, 0.000, 1.464', csv, re.MULTILINE))
        self.assertTrue(re.search('^3.140, 0, Car, 49.770, 1.811, 0.000, 0.243, 0.000, 0.000, 0.000, 0.000, 1.464', csv, re.MULTILINE))
        self.assertTrue(re.search('^3.150, 0, Car, 49.770, 1.811, 0.000, 0.243, 0.000, 0.000, 0.000, 0.000, 1.464', csv, re.MULTILINE))
        self.assertTrue(re.search('^7.000, 0, Car, 27.484, 0.507, 0.000, 5.745, 0.000, 0.000, 10.000, 0.276, 5.211', csv, re.MULTILINE))
        self.assertTrue(re.search('^8.600, 0, Car, 42.942, 2.380, 0.000, 0.225, 0.000, 0.000, 10.000, -0.022, 0.660', csv, re.MULTILINE))
        self.assertTrue(re.search('^14.500, 0, Car, 20.349, -4.156, 0.000, 3.655, 0.000, 0.000, 10.000, -0.379, 5.869', csv, re.MULTILINE))
        self.assertTrue(re.search('^16.500, 0, Car, 0.799, -8.131, 0.000, 3.287, 0.000, 0.000, 10.000, 0.000, 0.180', csv, re.MULTILINE))
        self.assertTrue(re.search('^19.200, 0, Car, 29.924, -28.426, 0.000, 1.919, 0.000, 0.000, 10.000, -0.058, 1.924', csv, re.MULTILINE))
        self.assertTrue(re.search('^23.000, 0, Car, 21.760, 8.661, 0.000, 1.753, 0.000, 0.000, 10.000, -0.000, 3.681', csv, re.MULTILINE))
        self.assertTrue(re.search('^27.510, 0, Car, 16.240, -3.138, 0.000, 3.203, 0.000, 0.000, 10.000, -0.379, 0.592', csv, re.MULTILINE))
        self.assertTrue(re.search('^35.050, 0, Car, 23.768, 1.326, 0.000, 5.235, 0.000, 0.000, 10.000, 0.200, 2.392', csv, re.MULTILINE))
        self.assertTrue(re.search('^37.000, 0, Car, 41.512, -1.397, 0.000, 0.193, 0.000, 0.000, 10.000, 0.000, 1.558', csv, re.MULTILINE))
    ...
    def test_ghost_restart(self):
        ...
        self.assertTrue(re.search('^2.000, 0, Ego, 69.859, -10.002, 0.000, 0.216, 0.000, 0.000, 10.000, 0.010, 0.566', csv, re.MULTILINE))
        self.assertTrue(re.search('^2.000, 1, Ego_ghost, 74.770, -8.892, 0.000, 0.173, 0.000, 0.000, 10.000, 0.000, 3.747', csv, re.MULTILINE))
        self.assertTrue(re.search('^5.000, 0, Ego, 99.652, -8.031, 0.000, 6.275, 0.000, 0.000, 10.000, 0.015, 4.598', csv, re.MULTILINE))
