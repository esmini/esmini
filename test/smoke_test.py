...
class TestSuite(unittest.TestCase):
    ...
    def test_alks(self):
        ...
        self.assertTrue(re.search('^4.980, 200, Ego, 147.354, -1.535, 0.000, 0.000, 0.000, 0.000, 14.030, 0.000, 1.693', csv, re.MULTILINE))
        self.assertTrue(re.search('^4.980, 201, Target, 152.279, -1.533, 0.000, 6.275, 0.000, 0.000, 10.008, 0.046, 5.307', csv, re.MULTILINE))
        ...
        self.assertTrue(re.search('^6.380, 100, Ego, 148.476, -1.535, 0.000, 0.000, 0.000, 0.000, 4.252, 0.000, 4.900', csv, re.MULTILINE))
