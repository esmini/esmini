...
"../../bin/replayer" --file simulation.dat --time_scale 5.0 --res_path ../../Resources --window 60 60 800 400 --quit_at_end
"../../bin/replayer" --file simulation.dat --time_scale 0.25 --res_path ../../Resources --window 60 60 800 400 --quit_at_end
